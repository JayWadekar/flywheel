...
:type: float
"""
GMsun_km = 1.3271244e+11 # km^3 s^-2
"""
Gravitational constant (:math:`G`) times a solar mass :math:`G \, {\\rm M}_{\odot}`, in cubic kilometers per second squared (:math:`\\rm km^3\, s^{-2}`).
